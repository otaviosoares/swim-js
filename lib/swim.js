...
function Swim(opts) {
    this.opts = opts;
    debug.enable('swim,swim:disseminator,swim:membership,swim:failure-detector,swim:net')
    ...
    this.membership = new Membership({
        local: opts.local,
        suspectTimeout: this.suspectTimeout,
        swim: this,
        debugIdentifier: opts.local.host
    });
    this.net = new Net({
    ...
    this.debug('I AM HOST', opts.local.host)
}
...
Swim.prototype.members = function members(hasLocal) {
    return this.membership.all(hasLocal);
};
