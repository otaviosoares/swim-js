...
Net.prototype.onError = function error() {
    this.debug('Net Error', Array.prototype.slice.call(arguments));
    this.emit(Net.EventType.Error);
};
...
Net.prototype.listen = function listen(callback) {
    ...
    this.debug('listening on port', this.udp.port)
